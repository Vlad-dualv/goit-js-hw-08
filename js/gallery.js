...
document.querySelector(".gallery").addEventListener("click", function (preventDownload) {
    preventDownload.preventDefault();
});
...
function handleClick(event) {
    ...
    const selectedImageUrl = event.target.getAttribute("data-source");
